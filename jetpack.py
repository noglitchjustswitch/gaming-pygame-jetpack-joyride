...
icon = pygame.image.load('assets\DialogueBarry0.png') # if using linux based os, then the slash has to be backslash
...
# load in player info in begginning
...
def draw_player():
    ...
    pygame.draw.rect(screen, 'gray', [100, player_y + 20, 20, 30], 0, 5)
